...
| Package | Executable | Personal | Company | Supported OS | Version/provenance policy |
| --- | --- | --- | --- | --- | --- |
| notion | ntn | required | optional | darwin, linux | exact-package-version |
| linear | linear | required | optional | darwin, linux, win32 | exact-package-version |
| jira | jira | optional | required | darwin, linux, win32 | exact-release-artifact |
| confluence | confluence | optional | required | darwin, linux, win32 | exact-package-version |
| github | gh | required | optional | darwin, linux, win32 | reviewed-package-manager-source |
| gitlab | glab | optional | required | darwin, linux, win32 | reviewed-package-manager-source |
