...
function buildPaletteReport(): string {
  return [
    ...
    "- /workspace-cli-status — show trusted-PATH readiness for Pi's Linear, Notion, and GitHub CLI profile.",
    ...
    "- Jira/Confluence — hosted connector entries remain runtime-gated; their CLI role tools belong to the Claude Code/OpenCode profile, not Pi's workspace-cli-tools extension.",
