...
function buildPaletteReport(): string {
  return [
    ...
    "- /workspace-cli-status — show trusted-PATH readiness for the Jira, Linear, GitHub, GitLab, Confluence, Notion, and CodeRabbit CLI tool pack.",
    ...
    "- Jira/Confluence — hosted connector entries remain runtime-gated; their separately authenticated jira-cli/confluence-cli tools are available when ENABLE_WORKSPACE_CLI_TOOLS=true.",
